...
$request->requestId = "024"; // unique payment reference (an order can have multiple payment attempts)
...
$request->totals = new \Paymennt\checkout\Totals(); // optional
...
$request->billingAddress = new \Paymennt\checkout\Address(); // required
...
$request->deliveryAddress = new \Paymennt\checkout\Address(); // required if shipping is required
...
$request->items[0] = new \Paymennt\checkout\Item();
